...
function processUnresponded() {
  ...
  var filters = [
    'is:sent',
    'from:me',
    'in:inbox', // exclude archived messages -- e.g. if an @Waiting message doesn't need followup, just archive it + remove label and it won't reappear 
    '-in:chats',
  ...
  threadMessages.forEach(function(messages, i) {
    ...
    if (isMe(lastFrom) && !isMe(lastTo) && lastMessageIsOld) {
